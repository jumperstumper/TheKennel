        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerDog = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CustomerDogBreed = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CustomerDogSocialNumber = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
